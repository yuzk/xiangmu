<template>
  <div
    class="zoom-wrap"
    :style="{ width: sSize.width + 'px', height: sSize.height + 'px' }"
  >
    <div
      ref="small"
      @mouseover="mouseOver"
    ...
    <div
      v-if="show"
      class="big"
      :style="{ width: bSize.width + 'px', height: bSize.height + 'px' }"
    >
      <img
        :src="bImg"
        :style="{
...
.zoom-wrap .small .mask {
  ...
  background-image: linear-gradient(
    ...
    linear-gradient(rgba(255, 255, 255, .8) 1%, rgba(0, 0, 0, 0) 5%);
